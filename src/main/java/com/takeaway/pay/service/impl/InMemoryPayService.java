...
public class InMemoryPayService implements PayService {
    ...
    protected boolean transfer(long customerId, long restaurantId, BigDecimal transferAmount,
                               LocalDate transferDate) throws PayException {
            ...
            synchronized (restaurantAccount) {
                ...
                try {
                    ...
                    if (lastDeductionDate != null && transferDate.isEqual(lastDeductionDate)) {
                        ...
                        dailyAmountTransferredPerCustomer.computeIfPresent(customerId, (custId, totalTransferAmount)
                                -> totalTransferAmount.add(transferAmount));
                    } else {
                    ...
                    //TODO: add logic to rollback(manually or by framework). for now, in this simple case this should not occur
                    return false;
                }
                return true;
            }
