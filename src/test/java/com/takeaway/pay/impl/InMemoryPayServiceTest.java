package com.takeaway.pay.impl;

import com.takeaway.pay.exception.PayException;
import com.takeaway.pay.service.impl.InMemoryPayService;
...
public class InMemoryPayServiceTest {
    ...
    public void testCreateNewCustomerAllowance() {
        ...
        assertEquals(BigDecimal.valueOf(0.0), payService.getCustomerAllowanceBalance(111),
    ...
    public void testTopUpCustomerAllowance() {
        ...
        assertEquals(BigDecimal.valueOf(20.0), payService.getCustomerAllowanceBalance(222),
                "Customer has incorrect balance after topup");
    }
    ...
    public void testCreateNewRestaurantAccount() {
        ...
        assertEquals(BigDecimal.valueOf(0.0), payService.getRestaurantAccountBalance(1),
                "new restaurant should have zero balance");
    }
